...
# Bot information
SESSION = environ.get('SESSION', 'Black_Panther')
API_ID = int(environ.get('API_ID', '20644083'))
API_HASH = environ.get('API_HASH', '1c19d83f619684587bcb0ba7c5d38383')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '855497512').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001727861199').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '855497512').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', '-1001697509286')
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001835917345'))
